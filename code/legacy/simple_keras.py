...
m.fit(x_train.fillna(0).values, y_train.values, validation_data=[x_valid.fillna(0).values, y_valid.values], nb_epoch=350, batch_size=64, verbose=2, callbacks=[history, chkpnt])
